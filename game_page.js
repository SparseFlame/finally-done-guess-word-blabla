...
function send(){
    ...
    lengthidk = Math.floor(word.length/2);
    charAt2 = word.charAt(lengthidk);
    console.log(charAt2);

    lengthx1 = word.length - 1;
    charAt3 = word.charAt(lengthx1);
    console.log(charAt3);
...
function check(){
    ...
    final_answer = answer_word.toLowerCase();
    console.log("Answer converted to lower case is " + final_answer);
